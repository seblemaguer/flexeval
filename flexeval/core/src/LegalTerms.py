    ...
    def minimal_GDPR_Compliance(self):
        if not (self.legal_terms["GDPR"] is None):
            ...
            if GDPR["data_controller"]["identity"] is None:
                print(
                    "   WARNING: Missing data_controller:identity in your legal file."
                )
                self.is_GDPR_Compliant = False
            ...
            if (
                ...
                print(
                    "   WARNING: Missing data_controller:contact:email and  data_controller:contact:other in your legal file."
                )
            ...
            if (
                ...
                print(
                    "   WARNING: Missing data_conservation:duration and data_conservation:criterions_duration in your legal file."
                )
                print("    -> Complete at least one of the two fields.")
                self.is_GDPR_Compliant = False
            ...
            if GDPR["data_protection_officer"]["identity"] is None:
                print(
                    "   WARNING: Missing data_protection_officer:identity in your legal file."
                )
                self.is_GDPR_Compliant = False
            ...
            if (
                ...
                print(
                    "   WARNING: Missing data_protection_officer:contact:email and data_protection_officer:contact:phone_number and data_protection_officer:contact:other in your legal file."
                )
