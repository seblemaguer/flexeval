...
<!--		<button>Toggle</button>   -->
		...
		<div class="container">
			...
			<h3>After listening to the sample, please rate it in terms of level of:</h3>
			...
			<li>	<b><font color=#D64400>Spontaneity:</font> </b> from <b>very prepared</b> (the reader knows his speech in advance) to <b>very spontaneous</b> (the speaker is improvising)
			</li>
			<li>	<b><font color=#4CB800>Expressiveness:</font></b> from <b>very inexpressive</b> (no sentiment nor emotion can be perceived) to <b>very expressive</b> (some sentiment or emotion can be perceived)
			</li>
...
<!-- 			Table header -->
				<thead>
					...
					<th class="text-center"><h4><strong>  sample 1    </strong></h4></th>
					<th class="text-center"><h4><strong>  sample 2    </strong></h4></th>
					<th class="text-center"><h4><strong>  sample 3    </strong></h4></th>
					<th class="text-center"><h4><strong>  sample 4    </strong></h4></th>
