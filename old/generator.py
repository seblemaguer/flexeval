...
def parse_arguments():
	...
	parser.add_argument('-j', '--json', help='Configuration file in JSON format', type=argparse.FileType('r'), required=True)
	parser.add_argument('-t', '--main-tpl', help='Template file of the iterating steps', type=str, required=True)
	parser.add_argument('-i', '--index-tpl', help='Template for the home/registration page', type=str, required=True)
	parser.add_argument('-c', '--completed-tpl', help='Template for the final page (completed test)', type=str, required=True)
	parser.add_argument('-e', '--export-tpl', help='Template of the export page', type=str, required=True)
	parser.add_argument('-s', '--systems', nargs='+', help='List of the systems', type=str, required=True)
	parser.add_argument('-n', '--name', help='Allow names after each system (default: no names)', action='store_true')
	...
	parser.add_argument('--csv-delimiter', help='Define the CSV delimiter (default: ;)', default=';')
