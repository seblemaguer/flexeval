...
with AdminModule('export_bdd', __name__,title="Download BDD",description="Download the database in CSV or SQLite format.") as ap:
    ...
    @ap.route('/')
    def panel():
        return utils.render_template("export_bdd/panel.tpl")
